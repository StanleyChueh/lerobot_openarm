...
# FPS = 30
# task = "pick up the white block from the red area"  # something like "pick the red block"
...
#     # pretrained_model_path = "/home/csl/lerobot_openarm/outputs/train/0409tist4/checkpoints/last/pretrained_model"
#     pretrained_model_path = "ethanCSL/0422_stanley_red_cube"
#     model = SmolVLAPolicy.from_pretrained(pretrained_model_path)

#     # dataset_id = "ethanCSL/0409tist"
...
# #     camera_config = {
# #     "camera1": OpenCVCameraConfig(index_or_path=16, width=640, height=480, fps=30),#right_camera
# #     "camera2": OpenCVCameraConfig(index_or_path=8, width=640, height=480, fps=30), #left_camera
...
#                 # ====== ✅ 3. dataset record (match dataset_features schema) ======
...
#                     "action": action_vec,
#                     **{
#                         f"observation.images.{cam_key}": obs_dict[cam_key]
...
#                 # 若使用者已經按了左/右鍵，就提早結束本 episode，
#                 # 外層再決定 discard 或 save
#                 if events["rerecord_episode"] or events["exit_early"]:
#                     break

#                 last_obs_dict = obs_dict

#                 # ====== 5. interpolation (unchanged) ======
...
#         if hasattr(record_dataset, "push_to_hub"):
#             try:
...
def main():
    ...
    pretrained_model_path = "ethanCSL/0422_stanley_red_cube_large_steps_ethanCSL_openarm"
    model = SmolVLAPolicy.from_pretrained(pretrained_model_path)
